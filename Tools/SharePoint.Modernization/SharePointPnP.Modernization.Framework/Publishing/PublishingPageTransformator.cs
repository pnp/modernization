    ...
    public class PublishingPageTransformator : BasePageTransformator
    {
        ...
        public string Transform(PublishingPageTransformationInformation publishingPageTransformationInformation)
        {
            ...
            if (pageType.Equals("PublishingPage", StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                pageData = new Tuple<Pages.PageLayout, List<WebPartEntity>>(pageData.Item1, new WikiTransformatorSimple().TransformPlusSplit(pageData.Item2, publishingPageTransformationInformation.HandleWikiImagesAndVideos));
            }
#if DEBUG && MEASURE
                Stop("Analyze page");
#endif
